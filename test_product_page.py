...
def test_message_disappeared_after_adding_product_to_basket(browser):
    ...
    page.open() # Открываем страницу товара
    page.add_to_basket() # Добавляем товар в корзину
    page.success_message_is_disappeared() # Проверяем, что сообщение об успехе исчезает с помощью is_disappeared
...
# Чтобы увидеть проверочный код в консоли, запускайте PyTest с параметром -s: pytest -v --tb=line --language=en -m need_review test_product_page.py